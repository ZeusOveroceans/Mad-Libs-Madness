...
function formValue(id) {
  // formvalue() retrieves a value from the DOM
  
  let formElement = document.getElementById(id);
  
  // formelement is used to reference a specific piece of the form
  ...
  let value = formElement.value;
	...
	// value is used to reference the value of the form element
...
function generate() {
  ...
  and we quickly became ${noun1}. Talk soon!
  <br><br>
  Your ${dessert},
  <br>
  ${petName}
